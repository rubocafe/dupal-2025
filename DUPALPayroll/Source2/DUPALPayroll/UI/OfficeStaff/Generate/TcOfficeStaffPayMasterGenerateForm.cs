...
{
    public partial class TcOfficeStaffPayMasterGenerateForm : Form
    {
        private TcOfficeStaffForm master;
        private BindingSource source = new BindingSource();

        public TcOfficeStaffPayMasterGenerateForm(TcOfficeStaffForm master)
        {
            InitializeComponent();
            ...
            try
            {
                if (AnalyzeCompleted())
                {
                    if (InputValid())
                    {
                        ...
                        TcOutputFilesGenerator<TcOfficeStaffAnalyzedRow> generator
                            = new TcOutputFilesGenerator<TcOfficeStaffAnalyzedRow>
        ...
        private void SetSummaryLabel()
        {
            ...
            TcPayMasterRowsValidator<TcOfficeStaffAnalyzedRow> validator =
                new TcPayMasterRowsValidator<TcOfficeStaffAnalyzedRow>(originData, master.AnalyzeForm.PaymasterDataList);
            validator.Validate();
        ...
        {
            TcSalaryConditionsChecker<TcOfficeStaffAnalyzedRow> checker = new TcSalaryConditionsChecker<TcOfficeStaffAnalyzedRow>(
        ...
        {
            referenceTextBox.Text = string.Format("OS SAL {0} '{1}",
        ...
        private bool GenerateSalarySlips()
        {
            ...
            TcOfficeStaffSalarySlipsCreator creator = new TcOfficeStaffSalarySlipsCreator(master.SettingsForm.WorkingYearMonth);
        ...
        private void TcOfficeStaffPayMasterGenerateForm_Load(object sender, EventArgs e)
        {
            try
            {
