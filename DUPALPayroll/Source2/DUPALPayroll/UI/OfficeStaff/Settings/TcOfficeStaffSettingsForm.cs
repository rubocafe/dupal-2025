...
namespace DUPALPayroll.UI.OfficeStaff.Settings
{
    public partial class TcOfficeStaffSettingsForm : Form
    {
        ...
        public TcOfficeStaffSettingsForm(TcOfficeStaffForm master)
        {
            InitializeComponent();
        ...
        private bool IsValid()
        {
            ...
            MasterFilePath = Path.Combine(RootDirectoryPath, string.Format("OfficeStaffMaster_{0}.csv", suffix));
            ...
            SalaryFilePath = Path.Combine(RootDirectoryPath, string.Format("OfficeStaffSalary_{0}.csv", suffix));
