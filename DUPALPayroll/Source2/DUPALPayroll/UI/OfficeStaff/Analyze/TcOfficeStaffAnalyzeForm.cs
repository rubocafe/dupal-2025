...
{
    public partial class TcOfficeStaffAnalyzeForm : Form
    {
        private TcOfficeStaffForm master;
        private BindingSource source = new BindingSource();

        public TcBindingList<TcOfficeStaffAnalyzedRow> PaymasterDataList { get; set; }

        public TcOfficeStaffAnalyzeForm(TcOfficeStaffForm master)
        {
            InitializeComponent();

            this.master = master;
            PaymasterDataList = new TcBindingList<TcOfficeStaffAnalyzedRow>();

            dataGridView.AutoGenerateColumns = false;

            source.DataSource = new TcBindingList<TcOfficeStaffAnalyzedRow>();
        ...
        public void Analyze()
        {
            try
            {
                ...
                if (DataLoaded())
                {
                    TcOfficeStaffAnalyzer loader = new TcOfficeStaffAnalyzer();
        ...
        private void SetFilter()
        {
            ...
            foreach (TcOfficeStaffAnalyzedRow data in PaymasterDataList)
            {
        ...
        private void dataGridView_SelectionChanged(object sender, EventArgs e)
        {
            try
            {
                TcOfficeStaffAnalyzedRow data = source.Current as TcOfficeStaffAnalyzedRow;
                if (data != null)
                {
        ...
        private void FilterAndSearch()
        {
            try
            {
                TcBindingList<TcOfficeStaffAnalyzedRow> filteredDataList = new TcBindingList<TcOfficeStaffAnalyzedRow>();
        ...
        private void Search()
        {
            ...
            TcSearchHelper<TcOfficeStaffAnalyzedRow> searchHelper = new TcSearchHelper<TcOfficeStaffAnalyzedRow>();
        ...
        private void SetStatus()
        {
            ...
            TcBindingList<TcOfficeStaffAnalyzedRow> list = source.DataSource as TcBindingList<TcOfficeStaffAnalyzedRow>;

            decimal total = 0;

            foreach (TcOfficeStaffAnalyzedRow row in list)
            {
