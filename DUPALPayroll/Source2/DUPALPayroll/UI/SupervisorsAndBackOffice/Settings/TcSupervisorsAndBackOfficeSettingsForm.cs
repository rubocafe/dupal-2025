...
namespace DUPALPayroll.UI.SupervisorsAndBackOffice.Settings
{
    public partial class TcSupervisorsAndBackOfficeSettingsForm : Form
    {
        ...
        public TcSupervisorsAndBackOfficeSettingsForm(TcSupervisorsAndBackOfficeForm master)
        {
            InitializeComponent();
        ...
        private bool IsValid()
        {
            ...
            SalaryFilePath = Path.Combine(RootDirectoryPath, string.Format("{0}Salary_{1}.csv", compressedIdentifier, suffix));
