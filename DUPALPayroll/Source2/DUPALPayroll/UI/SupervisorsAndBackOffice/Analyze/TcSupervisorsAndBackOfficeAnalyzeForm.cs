...
{
    public partial class TcSupervisorsAndBackOfficeAnalyzeForm : Form
    {
        private TcSupervisorsAndBackOfficeForm master;
        private BindingSource source = new BindingSource();

        public TcBindingList<TcSupervisorsAndBackOfficeAnalyzedRow> PaymasterDataList { get; set; }

        public TcSupervisorsAndBackOfficeAnalyzeForm(TcSupervisorsAndBackOfficeForm master)
        {
            InitializeComponent();

            this.master = master;
            PaymasterDataList = new TcBindingList<TcSupervisorsAndBackOfficeAnalyzedRow>();

            dataGridView.AutoGenerateColumns = false;

            source.DataSource = new TcBindingList<TcSupervisorsAndBackOfficeAnalyzedRow>();
        ...
        public void Analyze()
        {
            try
            {
                ...
                if (DataLoaded())
                {
                    TcSupervisorsAndBackOfficeAnalyzer loader = new TcSupervisorsAndBackOfficeAnalyzer();
        ...
        private void SetFilter()
        {
            ...
            foreach (TcSupervisorsAndBackOfficeAnalyzedRow data in PaymasterDataList)
            {
        ...
        private void dataGridView_SelectionChanged(object sender, EventArgs e)
        {
            try
            {
                TcSupervisorsAndBackOfficeAnalyzedRow data = source.Current as TcSupervisorsAndBackOfficeAnalyzedRow;
                if (data != null)
                {
        ...
        private void FilterAndSearch()
        {
            try
            {
                TcBindingList<TcSupervisorsAndBackOfficeAnalyzedRow> filteredDataList = new TcBindingList<TcSupervisorsAndBackOfficeAnalyzedRow>();
        ...
        private void Search()
        {
            ...
            TcSearchHelper<TcSupervisorsAndBackOfficeAnalyzedRow> searchHelper = new TcSearchHelper<TcSupervisorsAndBackOfficeAnalyzedRow>();
        ...
        private void SetStatus()
        {
            ...
            TcBindingList<TcSupervisorsAndBackOfficeAnalyzedRow> list = source.DataSource as TcBindingList<TcSupervisorsAndBackOfficeAnalyzedRow>;

            decimal total = 0;

            foreach (TcSupervisorsAndBackOfficeAnalyzedRow row in list)
            {
