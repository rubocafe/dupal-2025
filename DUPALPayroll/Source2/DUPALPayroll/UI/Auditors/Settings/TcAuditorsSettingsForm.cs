...
namespace DUPALPayroll.UI.Auditors.Settings
{
    public partial class TcAuditorsSettingsForm : Form
    {
        ...
        public TcAuditorsSettingsForm(TcAuditorsForm master)
        {
            InitializeComponent();
        ...
        private bool IsValid()
        {
            ...
            MasterFilePath = Path.Combine(RootDirectoryPath, string.Format("AuditorsMaster_{0}.csv", suffix));
            ...
            SalaryFilePath = Path.Combine(RootDirectoryPath, string.Format("AuditorsSalary_{0}.csv", suffix));
