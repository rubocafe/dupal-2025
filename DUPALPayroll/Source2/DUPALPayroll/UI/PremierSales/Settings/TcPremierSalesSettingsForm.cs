...
namespace DUPALPayroll.UI.PremierSales.Settings
{
    public partial class TcPremierSalesSettingsForm : Form
    {
        ...
        public TcPremierSalesSettingsForm(TcPremierSalesForm master)
        {
            InitializeComponent();
