...
using DUPALPayroll.UI.PremierSales.Generate;
using DUPALPayroll.UI.PremierSales.MasterData;
using DUPALPayroll.UI.PremierSales.Salary;
using DUPALPayroll.UI.PremierSales.Settings;
using System;
...
namespace DUPALPayroll.UI.PremierSales
{
    public partial class TcPremierSalesForm : TcForm
    {
        public string Identifier = TcPaths.PremierSalesId;

        private TcPremierSalesSettingsForm          settingsForm;
        private TcPremierSalesMasterForm            masterForm;
        private TcBanksAndBranchesForm              banksAndBranchesForm;
        private TcPremierSalesSalaryForm            salaryForm;
        private TcPremierSalesPayMasterGenerateForm payMasterGenerateForm;
        private TcPremierSalesAnalyzeForm           analyzeForm;

        public static bool ResetMasterFormFilter { get; set; }

        public TcPremierSalesSettingsForm SettingsForm
        {
            get { return settingsForm; }
        }

        public TcPremierSalesMasterForm MasterForm
        {
        ...
        public TcPremierSalesSalaryForm SalaryForm
        {
            get { return salaryForm; }
        }

        public TcPremierSalesAnalyzeForm AnalyzeForm
        {
            get { return analyzeForm; }
        }

        public TcPremierSalesForm()
        {
            InitializeComponent();

            settingsForm = new TcPremierSalesSettingsForm(this);
        }

        public bool InitializeFormsAndShowOtherTabs()
        {
            masterForm              = new TcPremierSalesMasterForm(this, settingsForm.MasterFilePath);
            banksAndBranchesForm    = new TcBanksAndBranchesForm(settingsForm.BanksAndBranchesFilePath);
            salaryForm              = new TcPremierSalesSalaryForm(this, settingsForm.SalaryFilePath);
            analyzeForm             = new TcPremierSalesAnalyzeForm(this);
            payMasterGenerateForm   = new TcPremierSalesPayMasterGenerateForm(this);
