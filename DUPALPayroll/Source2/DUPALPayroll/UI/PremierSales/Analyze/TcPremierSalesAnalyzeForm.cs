...
{
    public partial class TcPremierSalesAnalyzeForm : Form
    {
        private TcPremierSalesForm master;
        private BindingSource source = new BindingSource();

        public TcBindingList<TcPremierSalesAnalyzedRow> PaymasterDataList { get; set; }

        public TcPremierSalesAnalyzeForm(TcPremierSalesForm master)
        {
            InitializeComponent();

            this.master = master;
            PaymasterDataList = new TcBindingList<TcPremierSalesAnalyzedRow>();

            dataGridView.AutoGenerateColumns = false;

            source.DataSource = new TcBindingList<TcPremierSalesAnalyzedRow>();
        ...
        public void Analyze()
        {
            try
            {
                ...
                if (DataLoaded())
                {
                    TcPremierSalesAnalyzer loader = new TcPremierSalesAnalyzer();
        ...
        private void SetFilter()
        {
            ...
            foreach (TcPremierSalesAnalyzedRow data in PaymasterDataList)
            {
        ...
        private void dataGridView_SelectionChanged(object sender, EventArgs e)
        {
            try
            {
                TcPremierSalesAnalyzedRow data = source.Current as TcPremierSalesAnalyzedRow;
                if (data != null)
                {
        ...
        private void FilterAndSearch()
        {
            try
            {
                TcBindingList<TcPremierSalesAnalyzedRow> filteredDataList = new TcBindingList<TcPremierSalesAnalyzedRow>();
        ...
        private void Search()
        {
            ...
            TcSearchHelper<TcPremierSalesAnalyzedRow> searchHelper = new TcSearchHelper<TcPremierSalesAnalyzedRow>();
        ...
        private void SetStatus()
        {
            ...
            TcBindingList<TcPremierSalesAnalyzedRow> list = source.DataSource as TcBindingList<TcPremierSalesAnalyzedRow>;

            decimal total = 0;

            foreach (TcPremierSalesAnalyzedRow row in list)
            {
