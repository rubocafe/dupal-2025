...
{
    public partial class TcPremierSalesPayMasterGenerateForm : Form
    {
        private TcPremierSalesForm master;
        private BindingSource source = new BindingSource();

        public TcPremierSalesPayMasterGenerateForm(TcPremierSalesForm master)
        {
            InitializeComponent();
            ...
            try
            {
                if (AnalyzeCompleted())
                {
                    if (InputValid())
                    {
                        ...
                        TcOutputFilesGenerator<TcPremierSalesAnalyzedRow> generator
                            = new TcOutputFilesGenerator<TcPremierSalesAnalyzedRow>
        ...
        private void SetSummaryLabel()
        {
            ...
            TcPayMasterRowsValidator<TcPremierSalesAnalyzedRow> validator =
                new TcPayMasterRowsValidator<TcPremierSalesAnalyzedRow>(originData, master.AnalyzeForm.PaymasterDataList);
            validator.Validate();
        ...
        {
            TcSalaryConditionsChecker<TcPremierSalesAnalyzedRow> checker = new TcSalaryConditionsChecker<TcPremierSalesAnalyzedRow>(
        ...
        {
            referenceTextBox.Text = string.Format("PS SAL {0} '{1}",
        ...
        private bool GenerateSalarySlips()
        {
            ...
            TcPremierSalesSalarySlipsCreator creator = new TcPremierSalesSalarySlipsCreator(master.SettingsForm.WorkingYearMonth);
        ...
        private void TcPremierSalesPayMasterGenerateForm_Load(object sender, EventArgs e)
        {
            try
            {
