...
{
    public partial class TcCustomerCarePayMasterGenerateForm : Form
    {
        private TcCustomerCareForm master;
        private BindingSource source = new BindingSource();

        public TcCustomerCarePayMasterGenerateForm(TcCustomerCareForm master)
        {
            InitializeComponent();
            ...
            try
            {
                if (AnalyzeCompleted())
                {
                    if (InputValid())
                    {
                        ...
                        TcOutputFilesGenerator<TcCustomerCareAnalyzedRow> generator
                            = new TcOutputFilesGenerator<TcCustomerCareAnalyzedRow>
        ...
        private void SetSummaryLabel()
        {
            ...
            TcPayMasterRowsValidator<TcCustomerCareAnalyzedRow> validator =
                new TcPayMasterRowsValidator<TcCustomerCareAnalyzedRow>(originData, master.AnalyzeForm.PaymasterDataList);
            validator.Validate();
        ...
        {
            TcSalaryConditionsChecker<TcCustomerCareAnalyzedRow> checker = new TcSalaryConditionsChecker<TcCustomerCareAnalyzedRow>(
        ...
        {
            referenceTextBox.Text = string.Format("CC SAL {0} '{1}",
        ...
        private bool GenerateSalarySlips()
        {
            ...
            TcCustomerCareSalarySlipsCreator creator = new TcCustomerCareSalarySlipsCreator(master.SettingsForm.WorkingYearMonth);
        ...
        private void TcCustomerCarePayMasterGenerateForm_Load(object sender, EventArgs e)
        {
            try
            {
