...
{
    public partial class TcCallCenterInboundPayMasterGenerateForm : Form
    {
        private TcCallCenterInboundForm master;
        private BindingSource source = new BindingSource();

        public TcCallCenterInboundPayMasterGenerateForm(TcCallCenterInboundForm master)
        {
            InitializeComponent();
            ...
            try
            {
                if (AnalyzeCompleted())
                {
                    if (InputValid())
                    {
                        ...
                        TcOutputFilesGenerator<TcCallCenterInboundAnalyzedRow> generator
                            = new TcOutputFilesGenerator<TcCallCenterInboundAnalyzedRow>
        ...
        private void SetSummaryLabel()
        {
            ...
            TcPayMasterRowsValidator<TcCallCenterInboundAnalyzedRow> validator =
                new TcPayMasterRowsValidator<TcCallCenterInboundAnalyzedRow>(originData, master.AnalyzeForm.PaymasterDataList);
            validator.Validate();
        ...
        {
            TcSalaryConditionsChecker<TcCallCenterInboundAnalyzedRow> checker = new TcSalaryConditionsChecker<TcCallCenterInboundAnalyzedRow>(
        ...
        {
            referenceTextBox.Text = string.Format("CCI SAL {0} '{1}",
        ...
        private bool GenerateSalarySlips()
        {
            ...
            TcCallCenterInboundSalarySlipsCreator creator = new TcCallCenterInboundSalarySlipsCreator(master.SettingsForm.WorkingYearMonth);
        ...
        private void TcCallCenterInboundPayMasterGenerateForm_Load(object sender, EventArgs e)
        {
            try
            {
