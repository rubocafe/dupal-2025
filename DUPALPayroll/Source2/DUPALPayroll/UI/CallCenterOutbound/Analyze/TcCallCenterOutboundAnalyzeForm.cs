...
{
    public partial class TcCallCenterOutboundAnalyzeForm : Form
    {
        private TcCallCenterOutboundForm master;
        private BindingSource source = new BindingSource();

        public TcBindingList<TcCallCenterOutboundAnalyzedRow> PaymasterDataList { get; set; }

        public TcCallCenterOutboundAnalyzeForm(TcCallCenterOutboundForm master)
        {
            InitializeComponent();

            this.master = master;
            PaymasterDataList = new TcBindingList<TcCallCenterOutboundAnalyzedRow>();

            dataGridView.AutoGenerateColumns = false;

            source.DataSource = new TcBindingList<TcCallCenterOutboundAnalyzedRow>();
        ...
        public void Analyze()
        {
            try
            {
                ...
                if (DataLoaded())
                {
                    TcCallCenterOutboundAnalyzer loader = new TcCallCenterOutboundAnalyzer();
        ...
        private void SetFilter()
        {
            ...
            foreach (TcCallCenterOutboundAnalyzedRow data in PaymasterDataList)
            {
        ...
        private void dataGridView_SelectionChanged(object sender, EventArgs e)
        {
            try
            {
                TcCallCenterOutboundAnalyzedRow data = source.Current as TcCallCenterOutboundAnalyzedRow;
                if (data != null)
                {
        ...
        private void FilterAndSearch()
        {
            try
            {
                TcBindingList<TcCallCenterOutboundAnalyzedRow> filteredDataList = new TcBindingList<TcCallCenterOutboundAnalyzedRow>();
        ...
        private void Search()
        {
            ...
            TcSearchHelper<TcCallCenterOutboundAnalyzedRow> searchHelper = new TcSearchHelper<TcCallCenterOutboundAnalyzedRow>();
        ...
        private void SetStatus()
        {
            ...
            TcBindingList<TcCallCenterOutboundAnalyzedRow> list = source.DataSource as TcBindingList<TcCallCenterOutboundAnalyzedRow>;

            decimal total = 0;

            foreach (TcCallCenterOutboundAnalyzedRow row in list)
            {
