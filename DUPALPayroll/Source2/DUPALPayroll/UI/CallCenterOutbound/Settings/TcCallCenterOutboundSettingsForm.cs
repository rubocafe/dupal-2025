...
namespace DUPALPayroll.UI.CallCenterOutbound.Settings
{
    public partial class TcCallCenterOutboundSettingsForm : Form
    {
        ...
        public TcCallCenterOutboundSettingsForm(TcCallCenterOutboundForm master)
        {
            InitializeComponent();
