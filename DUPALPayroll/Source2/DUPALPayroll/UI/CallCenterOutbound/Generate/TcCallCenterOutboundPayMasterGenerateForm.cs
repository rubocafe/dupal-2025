...
{
    public partial class TcCallCenterOutboundPayMasterGenerateForm : Form
    {
        private TcCallCenterOutboundForm master;
        private BindingSource source = new BindingSource();

        public TcCallCenterOutboundPayMasterGenerateForm(TcCallCenterOutboundForm master)
        {
            InitializeComponent();
            ...
            try
            {
                if (AnalyzeCompleted())
                {
                    if (InputValid())
                    {
                        ...
                        TcOutputFilesGenerator<TcCallCenterOutboundAnalyzedRow> generator
                            = new TcOutputFilesGenerator<TcCallCenterOutboundAnalyzedRow>
        ...
        private void SetSummaryLabel()
        {
            ...
            TcPayMasterRowsValidator<TcCallCenterOutboundAnalyzedRow> validator =
                new TcPayMasterRowsValidator<TcCallCenterOutboundAnalyzedRow>(originData, master.AnalyzeForm.PaymasterDataList);
            validator.Validate();
        ...
        {
            TcSalaryConditionsChecker<TcCallCenterOutboundAnalyzedRow> checker = new TcSalaryConditionsChecker<TcCallCenterOutboundAnalyzedRow>(
        ...
        {
            referenceTextBox.Text = string.Format("CCO SAL {0} '{1}",
        ...
        private bool GenerateSalarySlips()
        {
            ...
            TcCallCenterOutboundSalarySlipsCreator creator = new TcCallCenterOutboundSalarySlipsCreator(master.SettingsForm.WorkingYearMonth);
        ...
        private void TcCallCenterOutboundPayMasterGenerateForm_Load(object sender, EventArgs e)
        {
            try
            {
