...
{
    public partial class TcCommissionAgentsPayMasterGenerateForm : Form
    {
        private TcCommissionAgentsForm master;
        private BindingSource source = new BindingSource();

        public TcCommissionAgentsPayMasterGenerateForm(TcCommissionAgentsForm master)
        {
            InitializeComponent();
            ...
            try
            {
                if (AnalyzeCompleted())
                {
                    if (InputValid())
                    {
                        ...
                        TcOutputFilesGenerator<TcCommissionAgentsAnalyzedRow> generator
                            = new TcOutputFilesGenerator<TcCommissionAgentsAnalyzedRow>
        ...
        private void SetSummaryLabel()
        {
            ...
            TcPayMasterRowsValidator<TcCommissionAgentsAnalyzedRow> validator = 
                new TcPayMasterRowsValidator<TcCommissionAgentsAnalyzedRow>(originData, master.AnalyzeForm.AnalyzedRows);
            validator.Validate();
        ...
        {
            TcCommissionAgentsConditionsChecker checker = new TcCommissionAgentsConditionsChecker(master);
        ...
        {
            referenceTextBox.Text = string.Format("COMMN {0} '{1}",
        ...
        private void TcCommissionAgentsPayMasterGenerateForm_Load(object sender, EventArgs e)
        {
            try
            {
