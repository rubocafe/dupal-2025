...
{
    public enum TeBusinessAnalyzeFilter
    {
        All,
        Valid,
        Employee_Age_Less_Than_16,
        ...
        Employee_EPF_Deduction_Invalid,
        Employee_EPF_Contribution_Invalid,
        Employee_ETF_Contribution_Invalid,
        ...
        Master_Employee_Number_not_Match,
