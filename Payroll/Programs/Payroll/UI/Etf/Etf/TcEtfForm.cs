    ...
    public partial class TcEtfForm : Form
    {
        ...
        public bool Reload()
        {
            ...
            try
            {
                ...
                TcEtfEmployerData origin = GetOriginData();
        ...
        private void AddFile(string business)
        {
            ...
            string fileName = string.Format("{0}_Etf_{1}.csv", business, master.SettingsForm.WorkingYearMonth.ToString());

            string filePath = Path.Combine(directoryPath, fileName);
            TcParsedEtfCsvFileInformation info = new TcParsedEtfCsvFileInformation(business, filePath);
            files.Add(info);
        }
        ...
        private void generateButton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string finalEtfFilePath = Path.Combine(folder, 
        ...
        private TcEtfEmployerData GetOriginData()
        {
            TcEtfEmployerData origin = new TcEtfEmployerData(master.SettingsForm.WorkingYearMonth);
