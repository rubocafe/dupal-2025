...
namespace Payroll.Library.Etf
{
    public class TcEtfDetailRow
    {
        ...
        public TcEtfDetailRow(TcEtfEmployerData employer, TcEtfMemberData member)
        {
            Identification      = "D";
        ...
        {
            // 2016/11/18: Commercial Bank updated the format to handle 12 digit NICs
            //
            string nicNumber = string.Empty;

            if (NICNumber.Length == 10)
            {
                nicNumber = TcString.AppendZerosToFront(NICNumber, 12);
            }
